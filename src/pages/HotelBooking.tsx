...
import { Building, Calendar as CalendarIcon, Users, CheckCircle2, ShieldCheck, MapPin } from "lucide-react"
...
export function HotelBooking() {
  ...
  const handlePaymentSuccess = async () => {
    ...
    try {
      ...
      toast.success("Your reservation is downloading.")
    } catch (error) {
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-8 text-center md:text-left">
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            Get a verifiable hotel reservation in your destination country. 100% safe for embassy checks.
          </p>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card className="border-slate-200 shadow-sm">
              <CardHeader className="bg-white border-b border-slate-100 pb-6">
                ...
                <CardDescription>Enter your stay information exactly as it appears on your itinerary.</CardDescription>
              </CardHeader>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input id="city" placeholder="e.g., Paris, France" className="pl-10" value={formData.city} onChange={handleInputChange} />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input id="checkin" type="date" className="pl-10" value={formData.checkin} onChange={handleInputChange} />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input id="checkout" type="date" className="pl-10" value={formData.checkout} onChange={handleInputChange} />
                        <CalendarIcon className="absolute left-3 top-2.5 h-5 w-5 text-slate-400" />
                      </div>
                    </div>
                  </div>
            ...
            <Card className="bg-slate-900 text-white border-none">
              <CardContent className="p-6 space-y-4">
                ...
                <ul className="space-y-3 text-sm text-slate-300">
                  ...
                  <li className="flex items-start">
                    <CheckCircle2 className="w-4 h-4 mr-2 mt-0.5 text-green-400 shrink-0" />
                    <span>Verifiable directly with hotel</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-4 h-4 mr-2 mt-0.5 text-green-400 shrink-0" />
