...
import { Calendar as CalendarIcon, Users, CheckCircle2, ShieldCheck, Ticket } from "lucide-react"
...
export function EventBooking() {
  ...
  const handleInitiatePayment = () => {
    if (!formData.eventName || !formData.eventDate || !formData.location || !formData.firstName || !formData.lastName || !formData.email) {
  ...
  const handlePaymentSuccess = async () => {
    ...
    try {
      ...
      toast.success("Your ticket is downloading.")
    } catch (error) {
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-8 text-center md:text-left">
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            Get verifiable event tickets (concerts, exhibitions, festivals) to prove the purpose of your visit.
          </p>
        </div>
              ...
              <CardContent className="pt-6">
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input id="eventName" placeholder="e.g., Tech Conference 2026" value={formData.eventName} onChange={handleInputChange} />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input id="eventDate" type="date" className="pl-10" value={formData.eventDate} onChange={handleInputChange} />
            ...
            <Card className="border-blue-100 shadow-md bg-white">
              ...
              <CardContent className="pt-4 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-600">Event Ticket (Dummy)</span>
                ...
                <div className="border-t border-slate-100 pt-4 flex justify-between items-center font-bold text-lg">
                  <span>Total</span>
                  <span className="text-blue-600">$20.00</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-900 text-white border-none">
              <CardContent className="p-6 space-y-4">
                ...
                <ul className="space-y-3 text-sm text-slate-300">
                  ...
                  <li className="flex items-start">
                    <CheckCircle2 className="w-4 h-4 mr-2 mt-0.5 text-green-400 shrink-0" />
                    <span>Proves purpose of visit</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-4 h-4 mr-2 mt-0.5 text-green-400 shrink-0" />
